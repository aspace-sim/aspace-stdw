...
struct engine_t {
     ...
     double warp_hard_cruise;  /* Added for hard cruise settings - Anya STDW */
     double impulse_hard_cruise;  /* Added for hard cruise settings - Anya STDW */
};
...
struct shield_t {
     ...
     double capacitor[MAX_SHIELD_NAME]; /* Added for shield capacitors - Anya STDW */
};
...
extern void alert_shield_charged (int x, int i);  /* Added by Anya - STDW for shield capacitors */
...
extern void alert_gravity_well (int x); /* Anyasha - STDW - Gravity Wells */
...
extern void up_gravity_wells (void); /* Added for gravity wells around plans-stars - Anya STDW */
extern void up_shieldcap (void); /* Added for shield capacitors - Anya STDW */
