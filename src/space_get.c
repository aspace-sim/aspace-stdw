...
/* shield ----------------------------------------------------------------- */
			case 'h': switch (f2[0]) {
				...
				case 'c': switch (f3[0]) { /* Anyasha - STDW - Shield Capacitors */
					case 'f': safe_str(unparse_number(sdb[x].shield.capacitor[0]), buff, bp); break;
					case 's': safe_str(unparse_number(sdb[x].shield.capacitor[1]), buff, bp); break;
					case 'a': safe_str(unparse_number(sdb[x].shield.capacitor[2]), buff, bp); break;
					case 'p': safe_str(unparse_number(sdb[x].shield.capacitor[3]), buff, bp); break;
					case 'd': safe_str(unparse_number(sdb[x].shield.capacitor[4]), buff, bp); break;
					case 'v': safe_str(unparse_number(sdb[x].shield.capacitor[5]), buff, bp); break;
					default: safe_str("#-1 NO SUCH FIELD", buff, bp); break;
					} break;
				case 'd': switch (f3[0]) {
