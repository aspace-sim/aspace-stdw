...
void damage_beam (int x, int beam, double damage)
{
	...
	do_console_notify(x, console_tactical, console_engineering, 0, /* Changed from damage to engineering - Anya STDW */
...
void damage_cloak (int x, double damage)
{
	...
	do_console_notify(x, console_helm, console_engineering, 0, /* Changed from damage to engineering - Anya STDW */
	  ansi_alert(tprintf("%s%s%s: %s %s",
...
void damage_ew (int x, double damage)
{
	...
	do_console_notify(x, console_tactical, console_science, console_engineering, /* Changed from damage to engineering - Anya STDW */
	  ansi_alert(tprintf("%s%s%s: %s %s",
...
void damage_tract (int x, double damage)
{
	...
	do_console_notify(x, console_operation, console_engineering, 0, /* Changed from damage to engineering - Anya STDW */
	  ansi_alert(tprintf("%s%s%s: %s %s",
...
void damage_trans (int x, double damage)
{
	...
	do_console_notify(x, console_operation, console_engineering, console_transporter, /* Changed from damage to engineering - Anya STDW */
	  ansi_alert(tprintf("%s%s%s: %s %s",
